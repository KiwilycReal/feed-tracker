...
| AC-P1-13 | Siri shortcuts (open/start/read) | PASS | `Sources/FeedTrackerCore/Features/SiriShortcutsHandler.swift`, `Sources/FeedTrackerCore/Features/FeedTrackerSiriAppIntents.swift`, `Sources/FeedTrackerCore/Features/FeedTrackerSiriIntentStartupWiring.swift`, `Sources/FeedTrackerCLI/main.swift`, `Tests/FeedTrackerCoreTests/SiriShortcutsHandlerTests.swift`, `docs/siri-shortcuts-manual-test.md`, `scripts/manual_siri_shortcuts.sh` |
